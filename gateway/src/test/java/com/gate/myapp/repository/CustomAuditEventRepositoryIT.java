package com.gate.myapp.repository;

import com.gate.myapp.GatewayApp;
import com.gate.myapp.config.Constants;
import com.gate.myapp.config.audit.AuditEventConverter;
import com.gate.myapp.domain.PersistentAuditEvent;
...
import static com.gate.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
